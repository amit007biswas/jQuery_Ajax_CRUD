...
namespace jQuery_Ajax_CRUD.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit(int id, [Bind("TransactionId,AccountNumber,BeneficiaryName,BankName,IfscCode,Amount,Date")] TransactionModel transactionModel)
        {
